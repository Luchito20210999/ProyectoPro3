...
public class AnalistaDAOImpl extends PersonaBaseDAO<Analista> implements AnalistaDAO {
    protected PreparedStatement comandoCrear(Connection conn,
                                             Analista modelo) throws SQLException {
        String sql = """
            INSERT INTO USUARIO (
                id_usuario,
                nombres,
    ...
    private int setCamposUsuario(PreparedStatement cmd, Analista modelo) throws SQLException {
    ...
    protected Analista mapearModelo(ResultSet rs) throws SQLException {
        Analista modelo = new Analista();
